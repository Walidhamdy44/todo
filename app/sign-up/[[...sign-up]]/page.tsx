        ...
        <div className="flex min-h-screen bg-[#0a0a0b]">
            ...
            <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden">
                ...
                <div className="absolute bottom-20 left-12 space-y-4 animate-in fade-in slide-in-from-bottom-5 duration-700">
                    <div className="bg-zinc-900/40 backdrop-blur-md border border-white/10 p-4 rounded-2xl flex items-center gap-4 w-60">
                        <div className="w-10 h-10 rounded-full bg-purple-500/20 flex items-center justify-center">
                            <div className="w-6 h-6 rounded-full bg-purple-500" />
                        </div>
                        <div>
                            <p className="text-zinc-400 text-xs font-medium">START</p>
                    ...
                    <div className="bg-zinc-900/40 backdrop-blur-md border border-white/10 p-4 rounded-2xl flex items-center gap-4 w-90 ml-8">
                        ...
                        <div>
                            <p className="text-zinc-400 text-xs font-medium">Create Account</p>
                            <p className="text-white font-bold">Join ProductiveAI and transform your workflow</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div className="w-full lg:w-1/2 flex flex-col items-center justify-center p-8 relative">
                <div className="w-full max-w-[400px] z-10">
                    <div className="mb-8 text-center lg:text-left">
                        ...
                        <p className="text-zinc-500 text-lg">Start your productivity journey</p>
                    </div>
                ...
                <div className="absolute top-1/4 left-0 w-64 h-64 bg-blue-500/5 blur-[100px] rounded-full -z-10" />
                <div className="absolute bottom-1/4 right-0 w-64 h-64 bg-[#00d084]/5 blur-[100px] rounded-full -z-10" />
            </div>
        </div>
    );
}
